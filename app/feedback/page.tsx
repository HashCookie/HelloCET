  ...
  return (
    <div className="mx-auto my-12 max-w-4xl bg-white px-6 font-[sans-serif] text-[#333] md:my-24 md:px-10">
      ...
      <div className="mb-8 text-center">
        <h1 className="font-extrabold text-2xl md:text-3xl">联系我</h1>
      </div>
      <div className="grid gap-8 md:grid-cols-2 md:gap-16">
        <div>
          ...
          <p className="mb-12 text-gray-500 text-sm">
            另外，如果你热衷于开源并愿意贡献力量，欢迎fork本项目。众人拾柴火焰高。
          </p>
        </div>
        <div className="space-y-12">
          <div>
            <h2 className="mb-6 font-bold text-xl">Email</h2>
            <a
          ...
          <div>
            <h2 className="mb-6 font-bold text-xl">Socials</h2>
