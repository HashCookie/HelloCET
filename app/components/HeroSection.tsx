  ...
  return (
    <section className="h-[calc(100vh-64px)] flex items-center justify-center">
      <div className="text-center px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="mt-10">
          <button className="w-full sm:w-auto px-6 py-2 text-sm sm:text-base sm:px-8 sm:py-3 rounded font-medium text-white bg-blue-600 hover:bg-blue-700 transition-colors">
            Get started
          </button>
        </div>
      </div>
