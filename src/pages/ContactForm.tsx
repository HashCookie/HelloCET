    ...
    <div className="grid px-10 sm:grid-cols-2 items-center gap-16 my-16 mx-auto max-w-4xl bg-white text-[#333] font-[sans-serif]">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-3">
          感谢你对项目的关注。请知悉，目前平台上的所有资料均为我个人上传。虽然我努力确保内容的准确与格式的规范，但可能仍有不足之处。若你发现任何错误或格式问题，请随时联系我反馈。你的意见对我们至关重要，有助于我们不断改进。
        </p>
        <p className="text-sm text-gray-400 mt-3">
          另外，如果你热衷于开源并愿意贡献力量，欢迎fork本项目。众人拾柴火焰高，你的加入能使我们的项目更完善，更好地服务社区。
        </p>
      </div>
