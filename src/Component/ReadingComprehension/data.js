...
export const questionsTwo = [
  ...
  {
    Number: 52,
    Statement: "Why is the medium soda priced the way it is?",
    Options: [
      {
        key: "A",
  ...
  {
    Number: 53,
    Statement: "What do we learn from Dan Ariely's experiment?",
    Options: [
      {
        key: "A",
